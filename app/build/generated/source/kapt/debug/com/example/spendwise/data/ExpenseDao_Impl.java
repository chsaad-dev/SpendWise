...
public final class ExpenseDao_Impl implements ExpenseDao {
  ...
  public LiveData<List<Expense>> searchExpenses(final String query) {
    final String _sql = "SELECT * FROM expenses WHERE note LIKE '%' || ? || '%' OR category LIKE '%' || ? || '%' ORDER BY date DESC";
  ...
  @Override
  public LiveData<List<Expense>> getExpensesByCategory(final String category) {
  ...
  @Override
  public LiveData<List<Expense>> getExpensesByCategoryAndDateRange(final String category,
      final long startDate, final long endDate) {
    final String _sql = "SELECT * FROM expenses WHERE category = ? AND date BETWEEN ? AND ? ORDER BY date DESC";
