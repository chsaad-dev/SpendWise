...
public abstract interface ExpenseDao {
    ...
    @androidx.room.Query(value = "SELECT SUM(amount) FROM expenses WHERE isIncome = 0")
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.lang.Double> getTotalExpense();
    
    @androidx.room.Query(value = "SELECT SUM(amount) FROM expenses WHERE isIncome = 1")
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.lang.Double> getTotalIncome();
    
    @androidx.room.Query(value = "SELECT SUM(amount) FROM expenses WHERE isIncome = 0 AND date BETWEEN :startDate AND :endDate")
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.lang.Double> getMonthlyExpense(long startDate, long endDate);
    
    @androidx.room.Query(value = "SELECT SUM(amount) FROM expenses WHERE isIncome = 1 AND date BETWEEN :startDate AND :endDate")
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.lang.Double> getMonthlyIncome(long startDate, long endDate);
    
    @androidx.room.Query(value = "SELECT category, SUM(amount) as total FROM expenses WHERE isIncome = 0 AND date BETWEEN :startDate AND :endDate GROUP BY category")
    @org.jetbrains.annotations.Nullable()
